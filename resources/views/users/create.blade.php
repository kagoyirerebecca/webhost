                                        ...
                                        <form method="POST" action="{{ route('users.store') }}">
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-md-6">
                                                    ...
                                                    <input class="form-control @error('fname') is-invalid @enderror" id="inputFirstName" type="text" value="{{old('fname')}}" name="fname" required autocomplete="fname" autofocus />
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input class="form-control @error('lname') is-invalid @enderror" id="inputFirstName" type="text" value="{{old('lname')}}" name="lname" required autocomplete="lname" autofocus />
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input class="form-control @error('co_name') is-invalid @enderror" id="inputFirstName" type="text" value="{{old('co_name')}}" name="co_name" required autocomplete="co_name" autofocus />
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input class="form-control @error('email') is-invalid @enderror" id="inputFirstName" type="email" value="{{old('email')}}" name="email" required autocomplete="email" autofocus />
